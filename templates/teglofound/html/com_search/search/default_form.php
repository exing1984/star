...
<form class="custom" id="searchForm" action="<?php echo JRoute::_('index.php?option=com_search');?>" method="post">
	...
	<div class="btn-toolbar">
			...
			<button name="Search" onclick="this.form.submit()" class="small button hasTooltip" title="<?php echo JHtml::tooltipText('COM_SEARCH_SEARCH');?>"><?php echo JHtml::tooltipText('COM_SEARCH_SEARCH');?></button>
