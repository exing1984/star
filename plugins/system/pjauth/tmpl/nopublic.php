 ...
 * @date $Date: 2013-09-15 11:07:18 +0200 (So, 15 Sep 2013) $
 * @revision $Revision: 849 $
 * @author $Author: toto $
 * @headurl $HeadURL: http://dev.teglo.info/svn/playjoom/plugins/system/pjauth/tmpl/nopublic.php $
 */
...
<jdoc:include type="message" />
	<div id="frame" class="outline">
		...
		<img src="<?php echo $params->get('frontpage_login_logoFile'); ?>" alt="<?php echo $app->getCfg('sitename'); ?>" />
		<?php endif; ?>
		<h2 class="subheader">
